        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-neutral-600 max-w-md">
              ...
              information for healthcare professionals, patients, and researchers. A Parnell Wellness resource.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/api/sitemap.xml" className="text-neutral-600 hover:text-neutral-900">Sitemap</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-500">
              © {currentYear} Parnell Wellness. All rights reserved.
            </p>
            <p className="text-xs text-neutral-400 text-center sm:text-right max-w-xl">
              ...
              <Link to="/disclaimer" className="underline ml-1">Read full disclaimer</Link>
            </p>
          </div>
        </div>
      </div>
